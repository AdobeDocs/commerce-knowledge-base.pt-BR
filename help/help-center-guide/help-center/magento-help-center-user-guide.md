...
>[!NOTE]
>
>Não é possível reabrir um caso respondendo a uma notificação por email de um tíquete fechado. Para reabrir o caso, verifique se você recebeu [Acesso Compartilhado](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-26164) pelo proprietário da conta.
