...
O patch MDVA-35984 corrige o problema ao criar várias entregas simultâneas para o mesmo produto que fornece uma quantidade de produto incorreta (Qtd). Este patch está disponível quando a variável [Ferramenta de correções de qualidade (QPT)](/help/announcements/adobe-commerce-announcements/magento-quality-patches-released-new-tool-to-self-serve-quality-patches.md) O 1.0.21 está instalado. A ID do patch é MDVA-35984. Observe que o problema foi corrigido no Adobe Commerce 2.4.3.
...
1. Criar um produto simples com o **Qtd** = *100*.
...
O resultado é produto **Qtd** = *98* após ambas as remessas.

<u>Resultados reais</u>:

O resultado é produto **Qtd** = *99* após ambas as remessas.
