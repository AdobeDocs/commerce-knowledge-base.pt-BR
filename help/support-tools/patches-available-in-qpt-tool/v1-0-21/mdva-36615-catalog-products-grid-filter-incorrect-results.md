...
O patch MDVA-36615 corrige o problema com a contagem de produtos incorreta na grade de produtos de administração. Este patch está disponível quando a variável [Ferramenta de correções de qualidade (QPT)](/help/announcements/adobe-commerce-announcements/magento-quality-patches-released-new-tool-to-self-serve-quality-patches.md) O 1.0.21 está instalado. A ID do patch é MDVA-36615. Observe que o problema está programado para ser corrigido no Adobe Commerce 2.4.3.
...
1. No *Admin* barra lateral, vá para **Catálogo** > **Produtos** > procure essa frase.
1. Clique em **Filtros**. Definir tipo para *Produto configurável*.
