...
O patch MDVA-34847 resolve o problema em que as consultas lentas ocorrem na tabela `customer_grid_flat`. Este patch está disponível quando a [Ferramenta de Patches de Qualidade (QPT)](/help/announcements/adobe-commerce-announcements/magento-quality-patches-released-new-tool-to-self-serve-quality-patches.md) 1.0.16 está instalada. Observe que o problema foi corrigido no Adobe Commerce versão 2.4.3.
...
Consultas lentas ocorrem na tabela `customer_grid_flat`.

<u>Etapas a serem reproduzidas</u>:

1. Crie um usuário Administrador com um escopo Personalizado (Exemplo: Defina **GWS** = *0,* e escolha o site padrão existente com **ID** = *1*).
...
1. Vá para a grade Vendas (**Vendas > Pedidos**).
