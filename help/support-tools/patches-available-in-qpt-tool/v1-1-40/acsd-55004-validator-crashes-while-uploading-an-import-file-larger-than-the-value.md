...
O patch ACSD-55004 corrige o problema em que um validador falha ao fazer upload de um arquivo de importação maior do que o valor configurado em `php.ini`. Este patch está disponível quando a variável [!DNL Quality Patches Tool (QPT)] O 1.1.40 está instalado. A ID do patch é ACSD-55004. Observe que o problema está programado para ser corrigido no Adobe Commerce 2.4.7.
...
Tentar carregar um arquivo de importação maior do que o configurado em `php.ini`.
