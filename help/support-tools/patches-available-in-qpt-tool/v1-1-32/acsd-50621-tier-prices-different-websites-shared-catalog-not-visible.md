...
O patch ACSD-50621 corrige o problema em que os preços de nível para sites diferentes no catálogo compartilhado não estão visíveis ao editá-los em um ambiente de vários sites. Este patch está disponível quando a variável [!DNL Quality Patches Tool (QPT)] O 1.1.32 está instalado. A ID do patch é ACSD-50621. Observe que o problema está programado para ser corrigido no Adobe Commerce 2.4.7.
...
1. Defina o **[!UICONTROL Catalog Price Scope]** para **[!UICONTROL Website]**.
...
1. Ir para **[!UICONTROL Set Pricing and Structure]** para o catálogo compartilhado personalizado que você criou.
...
1. Selecionar **[!UICONTROL Done]** e clique em **[!UICONTROL Generate Catalog]** e clique em **[!UICONTROL Save]**.
1. Execute o cron.
1. Navegue até **[!UICONTROL Set Pricing and Structure]** > **[!UICONTROL Configure]** > **[!UICONTROL Next]** > **[!UICONTROL Configure]** e verificar o preço da camada.
