...
Novas imagens de produtos são criadas no `pub/media` mesmo que a mesma imagem já exista, ao importar produtos.

<u>Etapas a serem reproduzidas</u>:

1. Crie um diretório para imagens: `mkdir var/import-images`
