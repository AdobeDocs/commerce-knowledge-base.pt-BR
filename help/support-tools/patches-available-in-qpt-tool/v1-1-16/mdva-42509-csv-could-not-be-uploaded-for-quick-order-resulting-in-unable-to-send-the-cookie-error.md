...
O patch MDVA-42509 resolve o problema em que não foi possível carregar um CSV para ordem rápida, resultando em *Não foi possível enviar o cookie* erro. Este patch está disponível quando a variável [Ferramenta de correções de qualidade (QPT)](/help/announcements/adobe-commerce-announcements/magento-quality-patches-released-new-tool-to-self-serve-quality-patches.md) O 1.1.16 está instalado. A ID do patch é MDVA-42509. Observe que o problema está programado para ser corrigido no Adobe Commerce 2.4.5.
...
Criar um pedido rápido com um grande número de produtos usando um CSV exibe um erro de cookie: *Não foi possível enviar o cookie*

<u>Etapas a serem reproduzidas</u>:

1. Habilitar a Ordem Rápida navegando até **Lojas** > **Configurações** > **Configurações** > **Geral** > **Recursos B2B**.
