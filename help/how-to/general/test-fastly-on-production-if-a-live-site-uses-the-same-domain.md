...
* [Envie um tíquete de suporte](https://experienceleague.adobe.com/en/docs/support-resources/adobe-support-tools-guide/adobe-commerce-support/adobe-commerce-help-center-user-guide#submit-ticket) solicitando a adição do subdomínio à configuração Fastly service/Nginx (para a arquitetura de plano do Adobe Commerce na infraestrutura em nuvem Pro).
...
* [Envie um tíquete de suporte](https://experienceleague.adobe.com/en/docs/support-resources/adobe-support-tools-guide/adobe-commerce-support/adobe-commerce-help-center-user-guide#submit-ticket) solicitando a validação do domínio de produção para o certificado SSL.
