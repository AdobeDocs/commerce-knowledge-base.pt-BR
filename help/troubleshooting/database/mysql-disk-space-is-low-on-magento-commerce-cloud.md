...
* *php: PDO::\_\_construct(): o servidor MySQL foi removido.*
...
* *SQLSTATE\[HY000\]: Erro geral: o servidor MySQL 2006 desapareceu*
* *\[ERROR\] SQL Escravo: Erro &#39;A tabela `<table\_name>` está cheia&#39; na consulta.*
* *A unidade mysql.service entrou em estado de falha.*
* *erro: &#39;Não é possível conectar ao servidor MySQL local através do soquete &#39;/var/run/mysqld/mysqld.sock&#39; (111 &quot;Conexão recusada&quot;)&#39;*
...
Uma das maneiras de verificar se o `/data/mysql` (ou sempre que o armazenamento de dados MySQL estiver configurado) está cheio é executando o seguinte comando na CLI:
...
Por exemplo, as tabelas com relatórios geralmente podem ser liberadas. Para obter detalhes sobre como localizar tabelas grandes, consulte o artigo [Localizar tabelas MySQL grandes](/help/how-to/general/find-large-mysql-tables.md).
...
Aloque mais espaço em disco para o MySQL se você tiver algum não utilizado. Consulte o artigo [Verificar limite de espaço em disco](/help/how-to/general/check-disk-space-limit-for-magento-commerce-cloud.md) para saber como verificar se há espaço livre em disco.

* Para os ambientes Starter plan, all ambientes e Pro plan Integration, é possível alocar o espaço em disco se você tiver algum não utilizado. Para obter detalhes, consulte o [Alocar mais espaço para MySQL](/help/how-to/general/allocate-more-space-for-mysql-in-magento-commerce-cloud.md).
