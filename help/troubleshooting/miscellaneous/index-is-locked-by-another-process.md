...
1. Por exemplo, digamos que o tipo de índice `cataloginventory_stock` esteja bloqueado.
1. Ao tentar reindexar todos os dados executando o comando da CLI:

   ```bash
   php bin/magento indexer:reindex
   ```

   Você obterá o seguinte resultado de output:
...
1. Como você pode ver acima, o processo de índice `cataloginventory_stock` foi ignorado.
