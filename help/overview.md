...
>[!NOTE]
>
>O guia da Base de conhecimento de suporte da Adobe Commerce está sendo reestruturado e seu conteúdo está sendo transferido para outros locais na Adobe Experience League. Use a [página de pesquisa e os filtros do Experience League](https://experienceleague.adobe.com/pt-br/search#) para encontrar a solução de problemas mais recente do Adobe Commerce e o conteúdo relacionado ao suporte.
