...
* Ferramentas de suporte {#support-tools}
   ...
   * Correções disponíveis na ferramenta QPT {#patches}
      ...
      * v1.1.22 {#v1-1-22}
         ...
         * [ACSD-47444: [!UICONTROL Trying to access array offset on value of type bool] erro ao acessar certos caminhos de categorias não existentes para produtos conhecidos no PHP 7.4](/help/support-tools/patches-available-in-qpt-tool/v1-1-22/acsd-47444-trying-access-array-offset-value-type-bool-error.md)
      ...
      * v1.1.23 {#v1-1-23}
         ...
         * [ACSD-46519: product_count em [!UICONTROL categoryList] [!DNL GraphQL] a consulta retorna 0 para categorias de âncora](/help/support-tools/patches-available-in-qpt-tool/v1-1-23/acsd-46519-product-count-categorylist-graphql-query-returns-zero-anchor-categories.md)
         * [ACSD-47027: consulta lenta em B2B [!UICONTROL CompanyRole] [!DNL GraphQL update]](/help/support-tools/patches-available-in-qpt-tool/v1-1-23/acsd-47027-slow-query-b2b-companyrole-graphql-update.md)
      ...
      * v1.1.24 {#v1-1-24}
         ...
         * [ACSD-47336: [!UICONTROL Something went wrong] notificações de erro rejeitadas pelo administrador do Adobe Commerce](/help/support-tools/patches-available-in-qpt-tool/v1-1-24/acsd-47336-something-went-wrong-error-when-dismissing-notifications-adobe-commerce-admin.md)
      ...
      * v1.1.25 {#v1-1-25}
         ...
         * [ACSD-48234: o resultado da pesquisa de catálogo mostra a contagem de itens de categoria incorreta quando [!UICONTROL Display Out of Stock Products] habilitado](/help/support-tools/patches-available-in-qpt-tool/v1-1-25/acsd-48234-catalog-search-result-shows-incorrect-category-item-count-when-show-out-of-stock-option-enabled.md)
         ...
         * [ACSD-48313: [!UICONTROL configurable_variations] coluna não analisada se o valor do atributo contiver vírgula](/help/support-tools/patches-available-in-qpt-tool/v1-1-25/acsd-48313-configurable-variations-column-not-parsed-attribute-value-contains-comma.md)
      ...
      * v1.1.29 {#v1-1-29}
         ...
         * [ACSD-49835: [!UICONTROL Use Default Value] a caixa de seleção não está salva](/help/support-tools/patches-available-in-qpt-tool/v1-1-29/acsd-49835-use-default-value-chekbox-not-saved.md)
         ...
         * [ACSD-49502: o link para download não é atualizado corretamente após [!DNL staging] atualizar](/help/support-tools/patches-available-in-qpt-tool/v1-1-29/acsd-49502-downloadable-link-not-updated-correctly.md)
      ...
      * v1.1.32 {#v1-1-32}
         ...
         * [ACSD-49628: [!DNL Page Builder] Erros do CORS impedem o salvamento do produto](/help/support-tools/patches-available-in-qpt-tool/v1-1-32/acsd-49628-page-builder-cors-errors-prevent-product-save.md)
         ...
         * [ACSD-51379: alterações no conteúdo de texto da página via [!DNL Page Builder] não são salvas](/help/support-tools/patches-available-in-qpt-tool/v1-1-32/acsd-51379-changes-made-to-page-text-content-via-page-builder-are-not-saved.md)
         ...
         * [ACSD-51294: Preço, quantidade, imposto, envio, receita enviada como cadeia de caracteres para [!DNL Google Analytics] e GTM](/help/support-tools/patches-available-in-qpt-tool/v1-1-32/acsd-51294-price-quantity-tax-shipping-and-revenue-are-sent-as-string-to-google-analytics-and-gtm.md)
      ...
      * v1.1.33 {#v1-1-33}
         ...
         * [ACSD-51735: status do item do pedido definido incorretamente como [!UICONTROL Ordered] quando o estoque do produto for 0](/help/support-tools/patches-available-in-qpt-tool/v1-1-33/acsd-51735-order-item-status-incorrectly-set.md)
      ...
      * v1.1.35{#v1-1-35}
         ...
         * [ACSD-51149: programado [!UICONTROL ImportExport] com ativado [!UICONTROL Catalog Permissions] invalida indexadores](/help/support-tools/patches-available-in-qpt-tool/v1-1-35/acsd-51149-scheduled-importexport-enabled-catalog-permissions-invalidates-indexers.md)
         ...
         * [ACSD-52786: regra de catálogo [!UICONTROL SKU is] se aplica a todos os produtos que começam com o SKU](/help/support-tools/patches-available-in-qpt-tool/v1-1-35/acsd-52786-catalog-rule-sku-is-applies-to-all-products-starting-with-it.md)
      ...
      * v1.1.36{#v1-1-36}
         ...
         * [ASCD-52736: [!UICONTROL Cart Price Rule] não funciona conforme o esperado](/help/support-tools/patches-available-in-qpt-tool/v1-1-36/acsd-52736-cart-price-rule-doesnt-work-as-expected.md)
         * [ACSD-53239: O indexador de inventário limpa todos os caches no [!UICONTROL Update on Schedule] modo](/help/support-tools/patches-available-in-qpt-tool/v1-1-36/acsd-53239-inventory-indexer-cleans-all-caches.md)
         * [ACSD-50887: [!UICONTROL Use in Search Results Layered Navigation] defina como Sim sem o [!UICONTROL Use in Search] opção](/help/support-tools/patches-available-in-qpt-tool/v1-1-36/acsd-50887-product-attribute-use-in-search-results-layered-navigation-set-to-yes-without-use-in-search-option.md)
         * [ACSD-51846: erro interno como [!DNL REST API] os níveis de carga não são validados](/help/support-tools/patches-available-in-qpt-tool/v1-1-36/acsd-51846-internal-error-as-levels-of-rest-api-payload-are-not-validated.md)
      ...
      * v1.1.39 {#v1-1-39}
         ...
         * [ACSD-54660: Nova classificação de atributo de entrada para classificar ordens de clientes em [!DNL GraphQL]](/help/support-tools/patches-available-in-qpt-tool/v1-1-39/acsd-54660-new-input-attribute-sort-to-sort-customer-orders-in-graphql.md)
      ...
      * v1.1.40 {#v1-1-40}
         ...
         * [ASCD-54040: [!UICONTROL Created] O campo está em branco para exibir detalhes da ordem quando os módulos B2B estão ativados](/help/support-tools/patches-available-in-qpt-tool/v1-1-40/acsd-54040-created-field-is-blank-in-order-details-page.md)
         ...
         * [ACSD-54319: o preço do produto mostra zero no [!UICONTROL Products in Carts] relatório](/help/support-tools/patches-available-in-qpt-tool/v1-1-40/acsd-54319-product-price-shows-zero-in-product-in-cart-report.md)
         * [ACSD-54989: o administrador da empresa não pode fazer pedidos quando [!UICONTROL Enable Purchase Orders] defina como Sim e [!UICONTROL Purchase Order] definir como Não](/help/support-tools/patches-available-in-qpt-tool/v1-1-40/acsd-54989-order-placement-restrictions-in-company-admin-settings.md)
      ...
      * v1.1.41 {#v1-1-41}
         ...
         * [ACSD-54376: exceção no carrinho de compras quando o produto é removido de [!UICONTROL shared catalog]](/help/support-tools/patches-available-in-qpt-tool/v1-1-41/acsd-54376-exception-shopping-cart-product-removed-from-shared-catalog.md)
      ...
      * v1.1.42 {#v1-1-42}
         ...
         * [ACSD-53568: [!UICONTROL Recently Viewed Product] dados não atualizados corretamente na exibição de armazenamento](/help/support-tools/patches-available-in-qpt-tool/v1-1-42/acsd-53658-fixes-the-issue-where-recently-viewed-product-data-is-not-updated-in-the-store-view.md)
         ...
         * [ACSD-55112: [!UICONTROL Submit Review] pode ser clicado várias vezes](/help/support-tools/patches-available-in-qpt-tool/v1-1-42/acsd-55112-submit-review-button-can-be-clicked-multiple-times.md)
         ...
         * [ACSD-54890: agrega_sales_report_bestsellers_data causes [!DNL MySQL] erros](/help/support-tools/patches-available-in-qpt-tool/v1-1-42/acsd-54890-aggregate-sales-report-bestsellers-data-causes-mysql-errors.md)
      ...
      * v1.1.43 {#v1-1-43}
         ...
         * [ACSD-55305: Congelamento de pop-ups durante a edição de usuários da empresa no [!UICONTROL My Account]](/help/support-tools/patches-available-in-qpt-tool/v1-1-43/acsd-55305-freeze-issue-in-company-user-edit-popup.md)
         ...
         * [ACSD-53636: o preço normal não é exibido em [!UICONTROL Product Listing] página](/help/support-tools/patches-available-in-qpt-tool/v1-1-43/acsd-53636-regular-price-is-not-displayed-on-product-listing-page.md)
         ...
         * [ACSD-53309: aplicação de imposto incompleta para opções personalizáveis e &#39;[!UICONTROL Regular Price]Rótulo &#39;](/help/support-tools/patches-available-in-qpt-tool/v1-1-43/acsd-53309-incomplete-tax-application-for-customizable-options.md)
         ...
         * [ACSD-54739: [!UICONTROL Product Stock] Status de não solicitado [!UICONTROL Related Product Rules]](/help/support-tools/patches-available-in-qpt-tool/v1-1-43/acsd-54739-product-stock-status-not-applied-for-related-product-rules.md)
      ...
      * v1.1.44 {#v1-1-44}
         ...
         * [ACSD-55352: Criação [!UICONTROL Credit Memo] com pontos de premiação](/help/support-tools/patches-available-in-qpt-tool/v1-1-44/acsd-55352-creating-credit-memos-with-reward-points.md)
      ...
      * v1.1.45 {#v1-1-45}
         ...
         * [ACSD-54965: [!UICONTROL Visual Merchandising] a grade não exibe o estoque correto](/help/support-tools/patches-available-in-qpt-tool/v1-1-45/acsd-54965-visual-merchandising-grid-not-display-correct-stock.md)
         ...
         * [ASCD-56415: Desempenho de [!UICONTROL Partial Price Indexing] está atrasado devido à consulta DELETE](/help/support-tools/patches-available-in-qpt-tool/v1-1-45/acsd-56415-performance-of-partial-price-indexing-is-slowed-down-due-to-a-delete-query.md)
      * v1.1.46 {#v1-1-46}
         * [Visão geral: [!DNL Quality Patches Tool] (QPT) v1.1.46](/help/support-tools/patches-available-in-qpt-tool/v1-1-46/overview.md)
         * [ACSD-46767: [!UICONTROL Category] os caches de página são invalidados quando a quantidade de estoque é alterada](/help/support-tools/patches-available-in-qpt-tool/v1-1-46/acsd-46767-category-page-caches-invalidate-when-the-stock-quantity-changes.md)
         * [ACSD-54656: Invisível [!DNL reCAPTCHA] falha durante o checkout, o que impede a realização do pedido](/help/support-tools/patches-available-in-qpt-tool/v1-1-46/acsd-54656-invisible-recaptcha-fails-during-checkout-preventing-order-placement.md)
         ...
         * [ACSD-55100: [!DNL GraphQL] não retorna produtos acima de 10.000 em resultados de pesquisa](/help/support-tools/patches-available-in-qpt-tool/v1-1-46/acsd-55100-graphql-does-not-return-products-beyond-10k-in-the-search-results.md)
      ...
      * v1.1.48 {#v1-1-48}
         ...
         * [ACSD-57315: a nova transação é criada em [!DNL PayPal Payflow Pro] sempre que o botão buscar for clicado](/help/support-tools/patches-available-in-qpt-tool/v1-1-48/acsd-57315-new-transaction-created-in-paypal-payflow-pro-each-time-the-fetch-button-is-clicked.md)
         ...
         * [ACSD-55566: [!UICONTROL mergeCart] falha na mutação com erro interno do servidor no [!DNL GraphQL] resposta](/help/support-tools/patches-available-in-qpt-tool/v1-1-48/acsd-55566-mergecart-mutation-fails-with-an-internal-server-error-in-graphql-response.md)
...
* Solução de problemas {#troubleshooting}
   ...
   * Banco de dados {#database}
      ...
      * [valor numérico do banco de dados Adobe Commerce fora do intervalo, [!DNL INT] para [!DNL BIGINT]](/help/troubleshooting/database/int-biginit-schema-update-request.md)
   ...
   * Pagamentos {#payments}
      * [Solução de problemas de criação de página de pedido no [!UICONTROL CSP] modo restrito](/help/troubleshooting/payments/admin-create-order-page-in-csp-restricted-mode.md)
      * [Solução de problemas da página de check-out do storefont no [!UICONTROL CSP] modo restrito](/help/troubleshooting/payments/storefront-checkout-page-in-csp-restricted-mode.md)
   ...
   * Instalação e atualização {#installation-and-upgrade}
      ...
      * [[!DNL B2B] Falha na instalação do 1.4.0 no Adobe Commerce 2.4.6-p1 no local](/help/troubleshooting/installation-and-upgrade/b2b-1-4-0-installation-fails-on-adobe-commerce-2-4-6-p1-on-premises.md)
   ...
   * Diversos {#miscellaneous}
      * [Como verificar o motivo [!DNL cron] foi desabilitado](/help/troubleshooting/miscellaneous/how-to-check-why-cron-was-disabled.md)
      ...
      * [Configuração de erro de desserialização de Redis:static-content:implantar](/help/troubleshooting/miscellaneous/redis-unserialize-error-setup-static-content-deploy.md)
      ...
      * [executar configuração:static-content:deploy deployed_version.txt problema](/help/troubleshooting/miscellaneous/run-setup-static-content-deploy-deployed-version-txt-issue.md)
      ...
      * [O arquivo não pode ser excluído. Aviso! desvincular: esse erro de arquivo ou diretório* não existe no [!DNL Admin]](/help/troubleshooting/miscellaneous/file-cannot-be-deleated-no-file-or-directory.md)
      * [[!DNL Admin] o logon não está funcionando - tamanho máximo de sessão permitido excedido](/help/troubleshooting/miscellaneous/admin-login-not-working-allowed-session-max-size-exceed.md)
      ...
      * [[!DNL SendGrid] limitação de arquivos para o Adobe Commerce Cloud](/help/troubleshooting/miscellaneous/sendgrid-file-limitation.md)
