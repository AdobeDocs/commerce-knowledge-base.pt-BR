...
* Ferramentas de Suporte {#support-tools}
   ...
   * Patches disponíveis na ferramenta QPT {#patches}
      ...
      * v1.1.4 {#v1-1-4}
         ...
         * [MC-42528: O query do GraphQL da categoryList mostra todas as categorias](/help/support-tools/patches-available-in-qpt-tool/v1-1-4/mc-42528-graphql-query-of-categorylist-shows-all-categories.md)
         * [MDVA-25631: não é possível salvar e atualizar segmentos do cliente](/help/support-tools/patches-available-in-qpt-tool/v1-1-4/mdva-25631-unable-to-save-and-refresh-customer-segments.md)
         * [MDVA-26005: não é possível selecionar categoria na árvore para as condições de regra de preço do carrinho](/help/support-tools/patches-available-in-qpt-tool/v1-1-4/mdva-26005-unable-to-select-category-in-tree-for-cart-price-rule-conditions.md)
         * [MDVA-29400: Pedidos duplicados feitos com PayPal Express Checkout](/help/support-tools/patches-available-in-qpt-tool/v1-1-4/mdva-29400-duplicated-orders-placed-with-paypal-express-checkout.md)
         * [MDVA-37725: Os emails enviados por sites não padrão contêm URLs de logotipo do site padrão](/help/support-tools/patches-available-in-qpt-tool/v1-1-4/mdva-37725-asynchronous-order-emails-sent-via-non-default-websites-containing-default-websites-logo-urls.md)
         ...
         * [MDVA-40399: Faturas parciais do mesmo solicitar não podem ser criadas simultaneamente por meio da API](/help/support-tools/patches-available-in-qpt-tool/v1-1-4/mdva-40399-partial-invoices-for-same-order-cannot-be-created-simultaneously-via-rest-api.md)
         * [MDVA-40401: alterações no valor de uso do cupom após falha na solicitar](/help/support-tools/patches-available-in-qpt-tool/v1-1-4/mdva-40401-coupon-usage-value-changes-even-after-failed-order.md)
         * [MDVA-40435: o desconto sobre pacote produto não é aplicado corretamente por meio do GraphQL](/help/support-tools/patches-available-in-qpt-tool/v1-1-4/mdva-40435-discount-on-bundle-product-is-not-applied-correctly-via-graphql.md)
         * [MDVA-40537: Criar armazenamento visualização dá erro quando várias páginas cms têm a mesma URL Chave.](/help/support-tools/patches-available-in-qpt-tool/v1-1-4/mdva-40537-creating-store-view-gives-error-when-multiple-cms-pages-with-same-url-keys-exist.md)
      * v1.1.5 {#v1-1-5}
         * [Visão geral: Ferramenta de patches de qualidade (QPT) v1.1.5](/help/support-tools/patches-available-in-qpt-tool/v1-1-5/overview.md)
         ...
         * [MDVA-37748: O GraphQL query retorna produtos não atribuídos ao catálogo compartilhado](/help/support-tools/patches-available-in-qpt-tool/v1-1-5/mdva-37748-graphql-query-returns-products-not-assigned-to-shared-catalog.md)
         * [MDVA-39229: Erro após atualizar o Catalog regra Staging start vez](/help/support-tools/patches-available-in-qpt-tool/v1-1-5/mdva-39229-error-updating-catalog-rule-staging-update-start-time.md)
         * [MDVA-40545: somente o primeiro nó para um página é recuperado](/help/support-tools/patches-available-in-qpt-tool/v1-1-5/mdva-40545-only-the-first-node-for-a-page-retrieved.md)
         * [MDVA-40619: As alterações de hierarquia quebram o CMS página edição em linha e geram um erro 500](/help/support-tools/patches-available-in-qpt-tool/v1-1-5/mdva-40619-hierarchy-changes-break-cms-page-inline-edit-and-throw-500-error.md)
         ...
         * [MDVA-41061: Stock status é redefinido para venda quando o produto é salvo do administrador](/help/support-tools/patches-available-in-qpt-tool/v1-1-5/mdva-41061-stock-status-resets-saleable-when-saved-from-admin.md)
         * [MDVA-41164: Não é possível salvar ou editar empresa com atributos personalizados do cliente](/help/support-tools/patches-available-in-qpt-tool/v1-1-5/mdva-41164-admin-user-cannot-save-or-edit-company-with-custom-customer-attributes.md)
         * [MDVA-41236: Não é possível criar atualizações programadas novas ou existentes para o produto](/help/support-tools/patches-available-in-qpt-tool/v1-1-5/mdva-41236-unable-to-create-new-or-edit-existing-scheduled-staging-update.md)
      * v1.1.6 {#v1-1-6}
         ...
         * [MDVA-30862: data da ordem incorreta na fatura impressa do PDF](/help/support-tools/patches-available-in-qpt-tool/v1-1-6/mdva-30862-incorrect-order-date-on-printed-pdf-invoice.md)
         * [MDVA-32776: Stock status não atualizado com solicitar posicionamento](/help/support-tools/patches-available-in-qpt-tool/v1-1-6/mdva-32776-stock-status-not-updated-when-order-placed.md)
         * [MDVA-39031: adicionar produtos não atribuídos à carrinho possível via GraphQL](/help/support-tools/patches-available-in-qpt-tool/v1-1-6/mdva-39031-adding-unassigned-products-to-cart-possible-via-graphql.md)
         ...
         * [MDVA-40550: produtos ausentes na frontend após reindexação](/help/support-tools/patches-available-in-qpt-tool/v1-1-6/mdva-40550-products-missing-on-the-frontend-after-reindexing.md)
         * [MDVA-40609: dados de produtos desativados ausentes cataloginventory_stock_status tabela](/help/support-tools/patches-available-in-qpt-tool/v1-1-6/mdva-40609-disabled-products-data-absent-in-cataloginventory-stock-status-table.md)
         * [MDVA-41399: Não é possível acessar o Gerenciar carrinho de compras se um cliente adicionar um produto à lista de desejos](/help/support-tools/patches-available-in-qpt-tool/v1-1-6/mdva-41399-unable-to-access-manage-shopping-cart-if-a-customer-adds-product-to-wishlist.md)
      ...
      * v1.1.7 {#v1-1-7}
         * [Visão geral: Ferramenta de patches de qualidade (QPT) v1.1.7](/help/support-tools/patches-available-in-qpt-tool/v1-1-7/overview.md)
         ...
         * [MDVA-41631: Erro recuperação de informações solicitar sem valor opcional de &quot;telefone&quot;](/help/support-tools/patches-available-in-qpt-tool/v1-1-7/mdva-41631-error-retrieving-order-information-without-optional-telephone-value.md)
      * v1.1.8 {#v1-1-8}
         * [Visão geral: Ferramenta de patches de qualidade (QPT) v1.1.8](/help/support-tools/patches-available-in-qpt-tool/v1-1-8/overview.md)
         * [MDVA-38393: As regras do catálogo param de funcionar para produtos configuráveis se seu produto simples for renomeado](/help/support-tools/patches-available-in-qpt-tool/v1-1-8/mdva-38393-catalog-rules-stop-working-for-configurable-product-if-its-simple-product-is-renamed.md)
         * [MDVA-39153: o valor do desconto é calculado incorretamente durante a reordenação na Administração](/help/support-tools/patches-available-in-qpt-tool/v1-1-8/mdva-39153-discount-amount-is-calculated-incorrectly-during-reorder-in-the-admin.md)
         * [MDVA-41139: Produto configurável fica sem estoque após a importação do produto](/help/support-tools/patches-available-in-qpt-tool/v1-1-8/mdva-41139-configurable-product-becomes-out-of-stock-after-product-import.md)
         ...
         * [MDVA-42326: clientes recebem erro no check-out após o tempo limite da sessão](/help/support-tools/patches-available-in-qpt-tool/v1-1-8/mdva-42326-customers-get-error-on-checkout-after-session-timeout.md)
         * [MDVA-42341: &quot;categoryList&quot; GraphQL query não filtra resultados](/help/support-tools/patches-available-in-qpt-tool/v1-1-8/mdva-42341-categorylist-graphql-query-does-not-filter-results.md)
      * v1.1.9 {#v1-1-9}
         * [Visão geral: Ferramenta de patches de qualidade (QPT) v1.1.9](/help/support-tools/patches-available-in-qpt-tool/v1-1-9/overview.md)
      ...
      * v1.1.13 {#v1-1-13}
         ...
         * [MDVA-42283: o formato de data e hora para Francês localidade é inválido](/help/support-tools/patches-available-in-qpt-tool/v1-1-13/mdva-42283-date-time-format-for-french-locale-invalid.md)
         * [MDVA-42969: o produto relacionado regra funciona apenas quando o segmento do cliente está definido como todos](/help/support-tools/patches-available-in-qpt-tool/v1-1-13/mdva-42969-related-product-rule-only-works-when-customer-segment-set-to-all.md)
         * [MDVA-43451: Erro ao definir Preços e estrutura para o catálogo compartilhado](/help/support-tools/patches-available-in-qpt-tool/v1-1-13/mdva-43451-error-when-setting-pricing-and-structure-for-shared-catalog.md)
         * [MDVA-43491: etiqueta de imagem base não é atualizada quando importada via CSV](/help/support-tools/patches-available-in-qpt-tool/v1-1-13/mdva-43491-base-image-label-not-updating-when-imported-via-csv.md)
         * [MDVA-43601: Os acionadores são removidos da tabela &quot;catalogrule_product_price&quot; após a reindexação completa](/help/support-tools/patches-available-in-qpt-tool/v1-1-13/mdva-43601-triggers-are-removed-from-catalogrule-product-price-table.md)
         ...
         * [MDVA-43862: O cliente não pode atualizar carrinho itens devido a um erro de mutação GraphQL UpdateCartItems](/help/support-tools/patches-available-in-qpt-tool/v1-1-13/mdva-43862-unable-to-update-cart-items-because-of-graphql-updatecartitems-mutation-error.md)
         * [MDVA-43935: produto upsell mostrado duas vezes em página do produto](/help/support-tools/patches-available-in-qpt-tool/v1-1-13/mdva-43935-upsell-product-shown-twice-on-product-page.md)
         * [MDVA-44188: Os emails não são enviados para IDs contendo &quot;.-&quot;](/help/support-tools/patches-available-in-qpt-tool/v1-1-13/mdva-44188-emails-are-not-sent.md)
      * v1.1.14 {#v1-1-14}
         * [Visão geral: Ferramenta de patches de qualidade (QPT) v1.1.14](/help/support-tools/patches-available-in-qpt-tool/v1-1-14/overview.md)
         * [MDVA-43102: Salable quantidade não foi atualizado corretamente](/help/support-tools/patches-available-in-qpt-tool/v1-1-14/mdva-43102-salable-quantity-not-updated-correctly.md)
         ...
         * [MDVA-44505: query GraphQL para carrinho aplicação de pontos de recompensa não atualiza o total geral](/help/support-tools/patches-available-in-qpt-tool/v1-1-14/mdva-44505-graphql-applying-reward-points-does-not-update-grand-total.md)
      * v1.1.15 {#v1-1-15}
         * [Visão geral: Ferramenta de patches de qualidade (QPT) v1.1.15](/help/support-tools/patches-available-in-qpt-tool/v1-1-15/overview.md)
         * [MDVA-38559: /V1/customers/pesquisa API retorna erro](/help/support-tools/patches-available-in-qpt-tool/v1-1-15/mdva-38559-v1-customers-search-api-error.md)
         * [MDVA-40896: erro &#39;Erro: TypeError: Argument 3&#39; no produto assíncrona](/help/support-tools/patches-available-in-qpt-tool/v1-1-15/mdva-40896-error-typeerror-in-async-product.md)
         * [MDVA-40961: Não é possível adicionar item adicional a carrinho quando o mínimo de quantidade do item já está em carrinho](/help/support-tools/patches-available-in-qpt-tool/v1-1-15/mdva-40961-additional-item-cant-be-added-to-cart-when-minimum-qty-of-the-item-already-in-cart.md)
         * [MDVA-43718: erro &#39;consumidor não está autorizado a acessar recursos&#39; aparece ao acessar catálogo compartilhado](/help/support-tools/patches-available-in-qpt-tool/v1-1-15/mdva-43718-not-authorized-to-access-resources-error-appears-when-accessing-shared-catalog.md)
         * [MDVA-44533: desconto aplicado incorretamente ao produto filho empacotado](/help/support-tools/patches-available-in-qpt-tool/v1-1-15/mdva-44533-discount-incorrectly-applied-to-bundle-child-product.md)
      ...
      * v1.1.16 {#v1-1-16}
         * [Visão geral: Ferramenta de patches de qualidade (QPT) v1.1.16](/help/support-tools/patches-available-in-qpt-tool/v1-1-16/overview.md)
         * [MDVA-42509: CSV não foi possível carregar para solicitar rápida resultando em erro &quot;Não é possível enviar o cookie&quot;](/help/support-tools/patches-available-in-qpt-tool/v1-1-16/mdva-42509-csv-could-not-be-uploaded-for-quick-order-resulting-in-unable-to-send-the-cookie-error.md)
         * [MDVA-43167: Administrador solicitar ação em massa de grade não se aplica a várias página](/help/support-tools/patches-available-in-qpt-tool/v1-1-16/mdva-43167-admin-order-grid-mass-doesnt-apply-multipage.md)
         * [MDVA-44044: Produto não exibido no categoria página depois de ser atribuído ao novo site](/help/support-tools/patches-available-in-qpt-tool/v1-1-16/mdva-44044-product-not-displayed-on-category-page-after-it-is-assigned-to-new-website.md)
         * [MDVA-44562: ID de armazenamento para itens de aspas substituída por padrão armazenamento id](/help/support-tools/patches-available-in-qpt-tool/v1-1-16/mdva-44562-store-id-quote-items-overridden-by-default-store-id.md)
         * [MDVA-44703: Totais de pedidos no relatório de pedidos são calculados incorretamente](/help/support-tools/patches-available-in-qpt-tool/v1-1-16/mdva-44703-order-totals-in-order-report-miscalculated.md)
         * [MDVA-44940: erro SQL ao salvar categoria de administrador](/help/support-tools/patches-available-in-qpt-tool/v1-1-16/mdva-44940-sql-error-while-saving-category-from-admin.md)
      * v1.1.17 {#v1-1-17}
         * [Visão geral: Ferramenta de patches de qualidade (QPT) v1.1.17](/help/support-tools/patches-available-in-qpt-tool/v1-1-17/overview.md)
         * [ACSD-42807: Sinal de moeda personalizado não exibido na vitrine](/help/support-tools/patches-available-in-qpt-tool/v1-1-17/acsd-42807-custom-currency-sign-not-displayed-on-store-front.md)
         * [ACSD-43887: Detalhes incorretos exibidos na página de pagamento de finalização](/help/support-tools/patches-available-in-qpt-tool/v1-1-17/acsd-43887-incorrect-details-displayed-on-checkout-payment-page.md)
         * [ACSD-44591: Erros ao solicitar sem confirmação CAPTCHA](/help/support-tools/patches-available-in-qpt-tool/v1-1-17/acsd-44591-user-gets-error-when-trying-to-place-order-without-captcha-confirmation.md)
         * [ACSD-45143: mutação setShippingAddressesOnCart não está definindo numérico código região como &quot;região&quot;](/help/support-tools/patches-available-in-qpt-tool/v1-1-17/acsd-45143-setshippingaddressoncart-mutation-doesnt-allow-setting-numeric-region-code.md)
      ...
      * v1.1.18 {#v1-1-18}
         ...
         * [ACSD-44938: VAT_ID não pode ser aplicada em solicitação GraphQL para usuário de hóspedes](/help/support-tools/patches-available-in-qpt-tool/v1-1-18/acsd-44938-vat-id-cannot-applied-graphql-guest-user.md)
         * [ACSD-45255: Exceção em relatórios de baixa Stock página para administrador restritos usuário](/help/support-tools/patches-available-in-qpt-tool/v1-1-18/acsd-45255-exception-on-low-stock-report-page-for-restricted-admin-user.md)
      ...
      * v1.1.24 {#v1-1-24}
         ...
         * [ACSD-47137: melhora a velocidade de carregamento da galeria de imagens quando o pub/mídia pasta grande](/help/support-tools/patches-available-in-qpt-tool/v1-1-24/acsd-47137-image-gallery-load-speed-improve-pub-media-big.md)
         * [ACSD-47079: O status do estoque de produtos compostos não é atualizado quando o status do estoque de subproteto é alterado](/help/support-tools/patches-available-in-qpt-tool/v1-1-24/acsd-47079-composite-products-stock-status-not-updated.md)
         ...
         * [ACSD-46617: Continuar ao Checkout botão acinzentado quando subtotal maior que a Quantia Mínima de Pedido](/help/support-tools/patches-available-in-qpt-tool/v1-1-24/acsd-46617-continue-to-checkout-button-greyed-out.md)
      * v1.1.25 {#v1-1-25}
         ...
         * [ACSD-48300: O retorno não pode ser criado se o produto configurável for removido](/help/support-tools/patches-available-in-qpt-tool/v1-1-25/acsd-48300-return-cannot-be-created-if-configurable-product-removed.md)
         ...
         * [ACSD-48058: Reindexação de preço do produto não funciona se o produto empacotado não receber o site](/help/support-tools/patches-available-in-qpt-tool/v1-1-25/acsd-48058-product-price-reindex-not-working-if-bundled-product-not-assigned-website.md)
         * [ACSD-48293: Produtos compostos em estoque quando esgotados produtos secundários reabastecidos](/help/support-tools/patches-available-in-qpt-tool/v1-1-25/acsd-48293-composite-products-go-out-of-stock.md)
      * v1.1.26 {#v1-1-26}
         * [Visão geral: Ferramenta de patches de qualidade (QPT) v1.1.26](/help/support-tools/patches-available-in-qpt-tool/v1-1-26/overview.md)
         * [ACSD-48773: Email de pontos de recompensa modelo retirado do armazenamento errado](/help/support-tools/patches-available-in-qpt-tool/v1-1-26/acsd-48773-reward-points-email-template-taken-from-wrong-store.md)
         ...
         * [ACSD-48587: o widget do produto não funciona com SKUs que contêm caracteres HTML](/help/support-tools/patches-available-in-qpt-tool/v1-1-26/acsd-48587-product-widget-not-working-with-html-characters.md)
         * [ACSD-48212: Importação de produto atribui produto à origem errada](/help/support-tools/patches-available-in-qpt-tool/v1-1-26/acsd-48212-product-import-assigns-product-wrong-source.md)
         * [ACSD-47988: A exportação do produto elimina as tags HTML de página descrição do produto do construtor](/help/support-tools/patches-available-in-qpt-tool/v1-1-26/acsd-47988-product-export-trims-html-tags.md)
         * [ACSD-48366: Imagem do produto não exibida no Anterior para Stock email modelo](/help/support-tools/patches-available-in-qpt-tool/v1-1-26/acsd-48366-product-image-not-displayed-back-stock-email-template.md)
         * [ACSD-48417: erro SQL após criar uma alteração de programação](/help/support-tools/patches-available-in-qpt-tool/v1-1-26/acsd-48417-sql-error-after-creating-a-schedule-change.md)
      * V1.1.27 {#v1-1-27}
         ...
         * [ACSD-48059: Os comerciantes não podem salvar o produto Corresponder ao regra para o atributo Categorias](/help/support-tools/patches-available-in-qpt-tool/v1-1-27/acsd-48059-merchants-cannot-save-the-match-product-by-rule-for-categories-attribute.md)
         * [ACSD-48362: a endereço de entrega padrão é usada em vez de uma nova](/help/support-tools/patches-available-in-qpt-tool/v1-1-27/acsd-48362-fixes-the-issue-where-the-default-shipping-address-is-used-instead-of-a-new-one.md)
         ...
         * [ACSD-49013: Confirmação de email não traduzida para a localidade do site](/help/support-tools/patches-available-in-qpt-tool/v1-1-27/acsd-49013-email-confirmation-not-translated-to-website-locale.md)
         * [ACSD-48216: AUTO_INCREMENT da tabela inventário_source_item aumenta na operação de ATUALIZAÇÃO](/help/support-tools/patches-available-in-qpt-tool/v1-1-27/acsd-48216-auto-increment-of-inventory-source-item-table-increases-on-the-update-operation.md)
         * [ACSD-49497: Pedido ainda processa após envio e reembolso parcial](/help/support-tools/patches-available-in-qpt-tool/v1-1-27/acsd-49497-order-is-still-processing-after-shipment-and-partial-refund.md)
         * [ACSD-48694: Uma alteração de estado inválida solicitada impede que o cliente coloque solicitar](/help/support-tools/patches-available-in-qpt-tool/v1-1-27/acsd-48694-invalid-state-change-requested-error-prevents-customer-from-placing-order.md)
      * v1.1.28 {#v1-1-28}
      ...
      * v1.1.33 {#v1-1-33}
         ...
         * [ACSD-51792: Página não tem impressão evento](/help/support-tools/patches-available-in-qpt-tool/v1-1-33/acsd-51792-page-does-not-have-impression-event.md)
         * [ACSD-51645: Salvar uma nova Regra de Preço do Carrinho se a extensão Magento_OfflineShipping estiver desabilitada](/help/support-tools/patches-available-in-qpt-tool/v1-1-33/acsd-51645-saving-a-new-cart-price-rule-if-the-extension-magento-offlineshipping-is-disabled.md)
         ...
         * [ACSD-52148: o reCAPTCHA do Google v3 administrador fazer logon falha ocasionalmente](/help/support-tools/patches-available-in-qpt-tool/v1-1-33/acsd-52148-google-v3-recaptcha-admin-login-fails-occasionally.md)
         ...
         * [ACSD-50895: as tags do Google Analytics 3 GTM não são acionadas se o Google Analytics 4 GTM não estiver configurado](/help/support-tools/patches-available-in-qpt-tool/v1-1-33/acsd-50895-google-analytics-3-gtm-tags-are-not-fired-if-google-analytics-4-gtm-is-not-configured.md)
         ...
         * [ACSD-51120: cache de solicitações do GraphQL GET não limpo para páginas do CMS que contêm blocos do CMS](/help/support-tools/patches-available-in-qpt-tool/v1-1-33/acsd-51120-graphql-get-requests-cache-not-cleared-for-cms-pages.md)
         * [ACSD-51700: Erro alternar armazenamento exibições em página de edição de produtos para download](/help/support-tools/patches-available-in-qpt-tool/v1-1-33/acsd-51700-downloadable-product-error-when-switching-storeviews.md)
         * [ACSD-51735: Status do item de pedido incorretamente definido para [!UICONTROL Ordered] quando o estoque do produto é 0](/help/support-tools/patches-available-in-qpt-tool/v1-1-33/acsd-51735-order-item-status-incorrectly-set.md)
      ...
      * v1.1.34{#v1-1-34}
         ...
         * [ACSD-50813: Administrador não pode adicionar produtos empacotados contendo uma barra](/help/support-tools/patches-available-in-qpt-tool/v1-1-34/acsd-50813-admin-unable-to-add-bundled-products-containing-a-slash.md)
         * [ACSD-52277: O administrador usuário redirecionado incorretamente ao selecionar armazenamento visualização ao criar novos solicitar](/help/support-tools/patches-available-in-qpt-tool/v1-1-34/acsd-52277-admin-user-redirected-incorrectly-on-selecting-store-view-when-creating-new-order.md)
         * [ACSD-52160: o resultado do validação do produto em relação ao preço carrinho regra](/help/support-tools/patches-available-in-qpt-tool/v1-1-34/acsd-52160-product-validation-result-against-the-cart-price-rule.md)
         ...
         * [ACSD-51857: O trabalho cron lento de agregado_sales_report_sellers_data afeta o desempenho](/help/support-tools/patches-available-in-qpt-tool/v1-1-34/acsd-51857-slow-cron-job-of-aggregate-sales-report-bestsellers-data-affects-performance.md)
      ...
      * v1.1.41 {#v1-1-41}
         ...
         * [ACSD-55414: Desempenho ruim quando MariaDB tenta lançar o entitys_ids](/help/support-tools/patches-available-in-qpt-tool/v1-1-41/acsd-55414-bad-performance-when-mariadb-tries-to-cast-the-entitys-ids.md)
         * [ACSD-53118: Regras do carrinho com cupom não funcionam corretamente](/help/support-tools/patches-available-in-qpt-tool/v1-1-41/acsd-53118-cart-rules-with-coupon-not-working-properly.md)
         * [ACSD-53643: O pedido tem um total incorreto ao colocar uma compra solicitar](/help/support-tools/patches-available-in-qpt-tool/v1-1-41/acsd-53643-order-has-an-incorrect-total-when-placing-a-purchase-order.md)
         * [ACSD-53722: o preço das opções de produto empacotado muda para $0](/help/support-tools/patches-available-in-qpt-tool/v1-1-41/acsd-53722-bundled-product-options-price-changes-to-0.md)
      ...
      * v1.1.42 {#v1-1-42}
         ...
         * [ACSD-54060: administrador restrito não pode salvar produto se for filho de outro produto](/help/support-tools/patches-available-in-qpt-tool/v1-1-42/acsd-54060-restricted-admin-cant-save-a-product.md)
         * [ACSD-54418: Valor de desconto fixo adicionado incorretamente ao produto secundário de pacote com preços dinâmicos](/help/support-tools/patches-available-in-qpt-tool/v1-1-42/acsd-54418-fixed-discount-amount-incorrectly-added-to-child-product-of-dynamically-priced-bundle.md)
         * [ACSD-55238: Salvando a meta descrição vazia do produto](/help/support-tools/patches-available-in-qpt-tool/v1-1-42/acsd-55238-saving-empty-product-meta-description.md)
         * [ACSD-53568: [!UICONTROL Recently Viewed Product] dados não atualizados corretamente na armazenamento visualização](/help/support-tools/patches-available-in-qpt-tool/v1-1-42/acsd-53658-fixes-the-issue-where-recently-viewed-product-data-is-not-updated-in-the-store-view.md)
         * [ACSD-55628: Carregar arquivo empresa registro formulário; substituir arquivo para a vitrine do atributo do cliente](/help/support-tools/patches-available-in-qpt-tool/v1-1-42/acsd-55628-upload-file-company-registration-form-replace-file-customer-attribute-storefront.md)
         * [ACSD-53845: problema de tempo limite de conexão MySQL quando o max_messages do consumidor = 0](/help/support-tools/patches-available-in-qpt-tool/v1-1-42/acsd-53845-mysql-connection-timeout-when-consumer-max-messages-equals-zero.md)
         ...
         * [ASCD-54264: Erro quando o cliente tenta sair com aspas negociáveis](/help/support-tools/patches-available-in-qpt-tool/v1-1-42/acsd-54264-error-when-customer-tries-to-checkout-with-negotiable-quote.md)
         * [ACSD-54626: Não é possível criar novas solicitar de compra regra com NUMBER_OF_SKUS via GraphQL](/help/support-tools/patches-available-in-qpt-tool/v1-1-42/acsd-54626-cant-create-new-purchase-order-rule-with-number-of-skus-attribute-via-graphql.md)
         * [ACSD-55381: Solucionar erros ao solicitar opção de produto configurável de B2B requisição lista](/help/support-tools/patches-available-in-qpt-tool/v1-1-42/acsd-55381-resolving-internal-server-error-in-b2b-graphql-queries.md)
         * [ACSD-54966: Correção para reutilização de códigos de cupom após ordens com falha](/help/support-tools/patches-available-in-qpt-tool/v1-1-42/acsd-54966-fix-for-limited-use-coupon-code-after-failed-orders.md)
      ...
      * v1.1.43 {#v1-1-43}
         ...
         * [ACSD-52714: O filtro de datas não funciona em administrador grade quando definido como y-m-d](/help/support-tools/patches-available-in-qpt-tool/v1-1-43/acsd-52714-date-filter-does-not-work-in-admin-grid-when-set-as-y-m-d.md)
         * [ACSD-56090: a resposta do GraphQL não é armazenamento específica](/help/support-tools/patches-available-in-qpt-tool/v1-1-43/acsd-56090-graphql-request-responds-all-stores-data-and-not-requested-store-data.md)
         * [ACSD-55610: Solicitar parcialmente cancelada tem um valor de desconto incorreto](/help/support-tools/patches-available-in-qpt-tool/v1-1-43/acsd-55610-partially-canceled-order-has-incorrect-discount-amount.md)
         ...
         * [ACSD-53636: O preço regular não é exibido na [!UICONTROL Product Listing] página](/help/support-tools/patches-available-in-qpt-tool/v1-1-43/acsd-53636-regular-price-is-not-displayed-on-product-listing-page.md)
         ...
         * [ACSD-54885: exceção durante o check-out de vários endereços quando administrador faz logon como cliente](/help/support-tools/patches-available-in-qpt-tool/v1-1-43/acsd-54885-exception-during-multiple-address-checkout.md)
      ...
      * v1.1.44 {#v1-1-44}
         ...
         * [ACSD-55231: SKU não encontrou erro ao usar solicitar rápido funcionalidade](/help/support-tools/patches-available-in-qpt-tool/v1-1-44/acsd-55231-sku-not-found-in-catalog.md)
         * [ACSD-55352: Criação [!UICONTROL Credit Memo] com pontos de recompensa](/help/support-tools/patches-available-in-qpt-tool/v1-1-44/acsd-55352-creating-credit-memos-with-reward-points.md)
         * [ACSD-55427: Admin usuário não pode cancelar a atribuição de produtos do catálogo compartilhado do página do produto](/help/support-tools/patches-available-in-qpt-tool/v1-1-44/acsd-55427-admin-user-cannot-unassign-product-from-shared-catalog-from-product-page.md)
         * [ACSD-56280: As compras no registro de presentes não foram concluídas](/help/support-tools/patches-available-in-qpt-tool/v1-1-44/acsd-56280-gift-registry-purchases-are-not-completed.md)
         * [ACSD-56193: [!DNL Fastly/Varnish] cache não limpo para conteúdo atualização de preparo](/help/support-tools/patches-available-in-qpt-tool/v1-1-44/acsd-56193-fastly-cache-not-cleared-for-content-staging-update.md)
         * [ACSD-56158: Valor de imposto errado na resposta do GraphQL quando várias regras fiscais aplicadas a carrinho](/help/support-tools/patches-available-in-qpt-tool/v1-1-44/acsd-56158-wrong-tax-value-in-graphql-when-multiple-tax-rules-applied-to-cart.md)
         * [ACSD-56023: Dispositivo conteúdo não está atualizando no página CMS](/help/support-tools/patches-available-in-qpt-tool/v1-1-44/acsd-56023-widget-content-not-updating-on-the-cms-page.md)
         * [ACSD-56246: Agendar atualizações de produtos apaga os valores de atributos de várias seleções](/help/support-tools/patches-available-in-qpt-tool/v1-1-44/acsd-56246-scheduling-product-updates-clears-multiselect-attributes-values.md)
         * [ACSD-56790: A opção de sair do estoque para a parte inferior não funciona ao classificar produtos no Visual Merchandiser](/help/support-tools/patches-available-in-qpt-tool/v1-1-44/acsd-56790-move-out-of-stock-to-bottom-option-does-not-work-while-sorting-products-in-the-visual-merchandiser.md)
      * v1.1.45 {#v1-1-45}
         * [Visão geral: [!DNL Quality Patches Tool] (QPT) v1.1.45](/help/support-tools/patches-available-in-qpt-tool/v1-1-45/overview.md)
         * [ACSD-56447: Adicionar o mesmo produto a carrinho por meio de solicitações paralelas de API REST da Web resulta em dois itens separados no carrinho](/help/support-tools/patches-available-in-qpt-tool/v1-1-45/acsd-56447-adding-same-product-to-cart-via-parallel-web-api-rest-requests-results-in-two-separate-items-in-the-cart.md)
         ...
         * [ACSD-56886: Produto configurável fica sem estoque quando produtos secundários são desativados](/help/support-tools/patches-available-in-qpt-tool/v1-1-45/acsd-56886-configurable-product-becomes-out-of-stock-when-child-products-are-disabled.md)
         * [ACSD-56515: Administrador com permissões não pode editar [!UICONTROL Dynamic Block]](/help/support-tools/patches-available-in-qpt-tool/v1-1-45/acsd-56515-admin-with-permissions-cannot-edit-dynamic-block.md)
         * [ACSD-56616: exibição storefront de produtos empacotados durante a simples escassez de estoque](/help/support-tools/patches-available-in-qpt-tool/v1-1-45/acsd-56616-out-of-stock-simple-products-trigger-bundle-display.md)
         * [ACSD-52824: Métodos de pagamento desativados exibidos para clientes do empresa](/help/support-tools/patches-available-in-qpt-tool/v1-1-45/acsd-52824-payment-method-display-dicrepancy.md)
         * [ASCD-56415: Desempenho de [!UICONTROL Partial Price Indexing] fica lento devido a DELETE query](/help/support-tools/patches-available-in-qpt-tool/v1-1-45/acsd-56415-performance-of-partial-price-indexing-is-slowed-down-due-to-a-delete-query.md)
      * v1.1.46 {#v1-1-46}
         * [Visão geral: [!DNL Quality Patches Tool] (QPT) v1.1.46](/help/support-tools/patches-available-in-qpt-tool/v1-1-46/overview.md)
         * [ACSD-46767: [!UICONTROL Category] caches página invalidados quando o estoque quantidade é alterado](/help/support-tools/patches-available-in-qpt-tool/v1-1-46/acsd-46767-category-page-caches-invalidate-when-the-stock-quantity-changes.md)
      ...
      * v1.1.49 {#v1-1-49}
         ...
         * [ACSD-58446: excluir uma equipe com usuários ou equipes secundárias por meio do GraphQL causa um erro não informativo](/help/support-tools/patches-available-in-qpt-tool/v1-1-49/ascd-58446-deleting-a-team-with-child-users-or-teams-via-graphql-gives-an-uninformative-error-message.md)
      ...
      * v1.1.50 {#v1-1-50}
         ...
         * [ACSD-58141: PHPSESSID é gerado novamente em solicitações POST para clientes conectados se o cache L2 Redis estiver ativado](/help/support-tools/patches-available-in-qpt-tool/v1-1-50/acsd-58141-phpsessid-regenerates-on-post-requests-for-logged-in-customers-with-l2-redis-cache-enabled.md)
         * [ACSD-59229: Alocação incorreta de dados de grupo do cliente devido a um valor X-Magento-Vary desatualizado](/help/support-tools/patches-available-in-qpt-tool/v1-1-50/acsd-59229-customer-group-segmentation-fix.md)
         ...
         * [ACSD-60303: Administrador solicitar posicionamento problema resolvido com minificação de HTML ativada](/help/support-tools/patches-available-in-qpt-tool/v1-1-50/acsd-60303-admin-order-placement-fix.md)
      * [Verifique correção se há Comércio problema com a ferramenta Patches de qualidade](/help/support-tools/patches-available-in-qpt-tool/check-patch-for-magento-issue-with-magento-quality-patches.md)
* Anúncios {#announcements}
   * [Visão geral dos anúncios](/help/announcements/overview.md)
   * Anúncios do Comércio da Adobe Systems {#commerce-announcements}
      * [Aprimoramento do ambiente de integração solicitação - Pro e Starter](/help/announcements/adobe-commerce-announcements/integration-environment-enhancement-request-pro-and-starter.md)
      * [Solicitações de capacidade de aumento de férias para Adobe Systems Comércio em nossa infraestrutura em nuvem](/help/announcements/adobe-commerce-announcements/holiday-surge-capacity-requests-for-magento-commerce-cloud.md)
      * [Atualização Compatibilidade Ferramenta 1.1.0 para Adobe Systems Comércio](/help/announcements/adobe-commerce-announcements/upgrade-compatibility-tool-for-magento.md)
      * [Perguntas frequentes sobre a política de ciclo de vida atualizada Adobe Systems versões Comércio lançamentos](/help/announcements/adobe-commerce-announcements/faq-for-the-updated-lifecycle-policy-for-magento-releases.md)
      * [Alternando para OpenSearch para Adobe Systems Comércio na Cloud 2.4.4](/help/announcements/adobe-commerce-announcements/switching-to-opensearch-for-adobe-commerce-on-cloud-2-4-4.md)
      * [Adobe Systems Comércio recomendações para vulnerabilidades de PHP](/help/announcements/adobe-commerce-announcements/magento-recommendations-for-php-vulnerabilities.md)
      * [Ferramenta patches de qualidade lançada: novas ferramenta para autoatendimento de patches de qualidade](/help/announcements/adobe-commerce-announcements/magento-quality-patches-released-new-tool-to-self-serve-quality-patches.md)
      * [O mecanismo de pesquisa do catálogo MySQL será removido em Adobe Systems Comércio 2.4.0](/help/announcements/adobe-commerce-announcements/mysql-catalog-search-engine-will-be-removed-in-magento-2-4-0.md)
   ...
   * Notícias da Central de Ajuda {#news}
      * [Descontinuação do centro de Comércio Ajuda da Adobe Systems](/help/announcements/help-center-news/decommissioning-of-adobe-commerce-help-center.md)
* Solucionando problemas {#troubleshooting}
   ...
   * Base de dados {#database}
      ...
      * [As alterações no banco de dados não são refletidas na vitrine](/help/troubleshooting/database/changes-in-the-database-are-not-reflected-on-the-storefront.md)
      * [Deadlocks no MySQL](/help/troubleshooting/database/deadlocks-in-mysql.md)
      * [Afunilamento de alta carga do MySQL no Adobe Systems Comércio no infraestrutura em nuvem](/help/troubleshooting/database/mysql-high-load-bottleneck-in-magento-commerce-cloud.md)
      ...
      * [Solução de problemas do armazenamento banco de dados na Comércio de Adobe Systems](/help/troubleshooting/database/database-storage-troubleshooter-on-adobe-commerce.md)
      * [As tabelas MySQL são muito grandes](/help/troubleshooting/database/mysql-tables-are-too-large.md)
      * [Erros de banco de dados relacionados ao max_allowed_packet no Adobe Systems Comércio](/help/troubleshooting/database/database-errors-related-to-max-allowed-packet-on-magento.md)
      * [Adobe Systems Comércio banco de dados numérico valor fora do intervalo, [!DNL INT]  para [!DNL BIGINT]](/help/troubleshooting/database/int-biginit-schema-update-request.md)
      * [Ler problemas de Replicações no Adobe Commerce Cloud 2.4.6 com MariaDB 10.6](/help/troubleshooting/database/read-replicas-issues-synchronization-mariadb-10-6.md)
   * Pagamentos {#payments}
      ...
      * [Adobe Systems Comércio problema conhecido 2.4.0: etiqueta &quot;Reembolso&quot; ausente em Klarna](/help/troubleshooting/payments/magento-2-4-0-known-issue-missing-refund-label-in-klarna.md)
      * [Adobe Systems Comércio 2.4.0: Braintree não na finalização de Vários endereços](/help/troubleshooting/payments/magento-2-4-0-braintree-not-in-multiple-addresses-checkout.md)
      * [2.3.4 PayPal hotfix do problema](/help/troubleshooting/payments/2-3-4-paypal-issue-hotfix.md)
      ...
      * [Adobe Systems Comércio problema conhecido 2.4.1: erro ao aparecer no Checkout com PayPal Braintree](/help/troubleshooting/payments/magento-2-4-1-known-issue-error-popping-up-on-checkout-with-paypal-braintree.md)
   ...
   * Site baixo ou sem resposta {#site-down-or-unresponsive}
      * [Site não acessível devido ao cloaking de origem](/help/troubleshooting/site-down-or-unresponsive/production-site-not-accessible-due-to-origin-cloaking.md)
      * [503 erro ao acessar Adobe Systems Comércio na Web navegador](/help/troubleshooting/site-down-or-unresponsive/503-error-accessing-magento-in-web-browser.md)
      * [O site falha ao carregar devido ao modo de manutenção deixado habilitado](/help/troubleshooting/site-down-or-unresponsive/site-fails-to-load-due-to-maintenance-mode-left-enabled.md)
   ...
   * Diversos {#miscellaneous}
      * [Os dados de correção não atualizados nos [!DNL Commerce Data Exporter] feeds e [!DNL cron] erros de logs com a tabela de alteração não existem](/help/troubleshooting/miscellaneous/mdee-table-does-not-exist.md)
      * [Como verificar por que [!DNL cron] foi desativado](/help/troubleshooting/miscellaneous/how-to-check-why-cron-was-disabled.md)
      * [ [!DNL opensearch] Erro mecanismo de pesquisa não existe. Voltar para [!DNL livesearch].](/help/troubleshooting/miscellaneous/error-opensearch-search-engine-doesnt-exist-falling-back-to-livesearch.md)
      * [Email informando que a armazenamento de exportação está quase cheia](/help/troubleshooting/miscellaneous/email-stating-that-export-storage-is-almost-full.md)
      * [Índices invalidados e &quot;indexer_reindex_all_inválido&quot; são executados constantemente](/help/troubleshooting/miscellaneous/constant-reindexing-with-cron-job-indexer-reindex-all-invalid.md)
      * [Arquivo de configuração ausente ou alterado](/help/troubleshooting/miscellaneous/missing-or-altered-config-file.md)
      * [cURL error 60: certificado SSL expirado](/help/troubleshooting/miscellaneous/curl-error-60-ssl-certificate-expired.md)
      * [Solucionar problemas de módulo de recomendações de produtos em Adobe Systems Comércio](/help/troubleshooting/miscellaneous/troubleshoot-product-recommendations-module-in-magento-commerce.md)
      ...
      * [Solução de problemas /montagem de tmp cheia para Adobe Systems Comércio](/help/troubleshooting/miscellaneous/tmp-mount-full.md)
      * [Módulo desconhecido Magento_BundleSampleData](/help/troubleshooting/miscellaneous/unknown-module-magento-bundlesampledata.md)
      * [Problemas de verificação de prontidão do cron](/help/troubleshooting/miscellaneous/cron-readiness-check-issues.md)
      * [O serviço Redis caiu](/help/troubleshooting/miscellaneous/redis-service-crashed.md)
      * [Queries SQL: EXPLICAR erros de custo](/help/troubleshooting/miscellaneous/sql-queries-explain-cost-errors.md)
      * [Adobe Systems Comércio 2.4.0 B2B Administrador não pode adicionar produtos configuráveis às aspas](/help/troubleshooting/miscellaneous/magento-2-4-0-b2b-admin-can-t-add-configurable-product-to-quote.md)
      * [Adobe Systems Comércio 2.3.6: spinner sem fim exibido na salvação do endereço](/help/troubleshooting/miscellaneous/magento-2-3-6-endless-spinner-displayed-on-address-save.md)
      * [Solução de problemas da relíquia da Novo na Comércio de Adobe Systems no infraestrutura em nuvem](/help/troubleshooting/miscellaneous/troubleshooting-new-relic-on-magento-commerce-cloud.md)
      * [404 erro não encontrado ao acessar o Assistente de configuração da Web por meio do painel Admin.](/help/troubleshooting/miscellaneous/404-error-web-set-up-wizard-cloud.md)
      * [Ativar cache para evitar a degradação de desempenho](/help/troubleshooting/miscellaneous/enable-magento-cache-to-avoid-performance-degradation.md)
      * [Guia Adobe Systems Comércio de solução de problemas do Security Scan ferramenta](/help/troubleshooting/miscellaneous/security-scan-tool-troubleshooting-guide.md)
      * [problemas de verificação de permissões Arquivo de prontidão para permissões](/help/troubleshooting/miscellaneous/file-permissions-readiness-check-issues.md)
      * [A armazenamento em cache rápida não está trabalhando no Comércio de Adobe Systems no infraestrutura em nuvem](/help/troubleshooting/miscellaneous/fastly-caching-is-not-working-on-magento-cloud.md)
      * [Como diagnosticar comércio eletrônico google receita discrepâncias](/help/troubleshooting/miscellaneous/diagnosing-google-ecommerce-revenue-discrepancies.md)
      * [Eu configurei chaves de API para Sensei, mas só vejo um espaço de dados SaaS](/help/troubleshooting/miscellaneous/i-have-configured-api-keys-for-sensei-but-only-seeing-1-saas-data-space.md)
      ...
      * [Espaço baixo em disco](/help/troubleshooting/miscellaneous/low-disk-space.md)
      * [Aquecimento de cache e site indisponível no Adobe Systems Comércio](/help/troubleshooting/miscellaneous/cache-warming-up-and-site-unavailable-on-magento.md)
      * [Resolução de erros UTF-8 para uploads de arquivos CSV](/help/troubleshooting/miscellaneous/resolving-utf-8-errors-for-csv-file-uploads.md)
      * [Solução de problemas de desempenho usando Novo Relic na Adobe Systems Comércio](/help/troubleshooting/miscellaneous/troubleshoot-performance-using-new-relic-on-magento-commerce.md)
      * [Problema conhecido da contagem de produtos de ação em massa no Adobe Systems Comércio 2.3.5](/help/troubleshooting/miscellaneous/bulk-action-product-count-known-issue-in-magento-2-3-5.md)
      ...
      * [Erro de loop de página ou redirecionar em branco ao acessar a vitrine ou o administrador da Comércio](/help/troubleshooting/miscellaneous/blank-page-or-redirect-loop-error-when-accessing-storefront-or-magento-admin.md)
      * [Adobe Systems Comércio atualização de endereço de texto 2.4.1 validação mensagem postagem endereço](/help/troubleshooting/miscellaneous/magento-2-4-1-vertex-address-validation-message-post-address-update.md)
      ...
      * [Adobe Systems Comércio problema conhecido 2.4.0: Criar botões Novo Pedido ausentes](/help/troubleshooting/miscellaneous/magento-2-4-0-known-issue-create-new-order-buttons-missing.md)
      * [laminas/laminas-escaper 2.7.1 causa erro Adobe Systems Comércio frontend e páginas de administrador](/help/troubleshooting/miscellaneous/laminas-escaper-2-7-1-causes-error-adobe-commerce-frontend-and-admin-pages.md)
      * [403 erros ao acessar a ferramenta de análise de todo o site em Adobe Systems Comércio](/help/troubleshooting/miscellaneous/403-errors-when-accessing-site-wide-analysis-tool-on-magento.md)
      * [Solução de problemas de relatórios Avançado para o Comércio de Adobe Systems](/help/troubleshooting/miscellaneous/magento-advanced-reporting-troubleshooter.md)
      ...
      * [Falha na exportação manual da ordem para o MOM. A botão do pedido de exportação retorna um erro HTTP 404](/help/troubleshooting/miscellaneous/manual-order-export-to-mom-fails-the-export-order-button-returns-http-404-error.md)
      ...
      * [Acesso restrito administrador causando problemas de desempenho](/help/troubleshooting/miscellaneous/restricted-admin-access-causing-performance-issues.md)
      * [Tarefas cron bloqueiam tarefas de outros grupos](/help/troubleshooting/miscellaneous/cron-tasks-lock-tasks-from-other-groups.md)
      * [Campos bloqueados (esmaeçados) no Comércio Administrador](/help/troubleshooting/miscellaneous/locked-fields-in-magento-admin.md)
      * [Não é possível alterar Search Mecanismo usando Comércio Administrador (o menu Mecanismo Search está inacessível)](/help/troubleshooting/miscellaneous/cannot-change-search-engine-using-magento-admin-search-engine-menu-is-inaccessible.md)
      * [Erro de nível de aninhamento de função máxima do xdebug de instalação](/help/troubleshooting/miscellaneous/installation-xdebug-maximum-function-nesting-level-error.md)
      ...
      * [Adobe Systems Comércio 2.4.0: &quot;Adicionar seleções à minha carrinho&quot; não funciona](/help/troubleshooting/miscellaneous/magento-2-4-0-add-selections-to-my-cart-does-not-work.md)
      * [MBI: discrepâncias de dados](/help/troubleshooting/miscellaneous/mbi-data-discrepancies.md)
      * [Scripts de lado do servidor personalizados não executados no diretório de mídia do pub](/help/troubleshooting/miscellaneous/custom-server-side-scripts-not-executed-in-pub-media-directory.md)
      * [Problemas de verificação de prontidão para versão PHP](/help/troubleshooting/miscellaneous/php-version-readiness-check-issues.md)
      * [O site da nuvem está lento](/help/troubleshooting/miscellaneous/cloud-site-is-slow.md)
      ...
      * [Problema de token do Github e procedimentos principais do Composer](/help/troubleshooting/miscellaneous/github-token-issue-and-composer-key-procedures.md)
      * [Adobe Systems Comércio problema 2.4.1: não é possível alterar o conta de Amazon no Cromo](/help/troubleshooting/miscellaneous/magento-2-4-1-known-issue-unable-to-change-amazon-account-in-google-chrome.md)
      * [Erros de atualização da ECE-Ferramentas e correção Adobe Systems Comércio infraestrutura em nuvem 2.2.x., 2.3.x](/help/troubleshooting/miscellaneous/ece-tools-and-patch-update-errors-magento-commerce-cloud-2-2-x-2-3-x.md)
      * [PWA Studio: Webpack trava antes de iniciar a compilação](/help/troubleshooting/miscellaneous/pwa-studio-webpack-hangs-before-beginning-compilation.md)
      * [Instale os patches mais recentes para corrigir Adobe Systems Comércio problemas do Redis](/help/troubleshooting/miscellaneous/install-latest-patches-to-fix-magento-redis-issues.md)
      * [Resolver um erro de deslocamento ilegal](/help/troubleshooting/miscellaneous/resolve-an-illegal-offset-error.md)
      * [As categorias do GraphQL query a ocultar não funcionam com B2B catálogo compartilhado](/help/troubleshooting/miscellaneous/graphql-categories-cannot-hide-categories-shared-catalog.md)
      ...
      * [Erro rápido: a versão VCL do plug-in está ultrapassada! Faça upload novamente](/help/troubleshooting/miscellaneous/fastly-error-plugin-vcl-version-is-outdated-please-re-upload.md)
      ...
      * [O problema da pasta var/export permissão Adobe Systems Comércio na nuvem](/help/troubleshooting/miscellaneous/issue-in-the0email-folder-adobe-commerce.md)
      * [Atualizações de preparo de conteúdo programadas não exibidas com cache obsoleto rapidamente](/help/troubleshooting/miscellaneous/scheduled-content-staging-updates-not-displayed-with-stale-fastly-cache.md)
      * [Solucionar problemas do cron](/help/troubleshooting/miscellaneous/troubleshoot-cron.md)
      * [Produtos exportados .csv arquivo não aparecem](/help/troubleshooting/miscellaneous/exported-products-csv-file-does-not-appear.md)
      ...
      * [Verificando implantação log se o Cloud interface tiver erro de &quot;log cortado&quot;](/help/troubleshooting/miscellaneous/checking-deployment-log-if-the-cloud-ui-shows-log-snipped-error.md)
   ...
   * Problemas conhecidos {#known-issues-patches-attached}
      * [Adobe Systems Comércio pacote de compatibilidade 2.4.7-p4 [!DNL HIPAA] 1.2.0 Hotfix](/help/troubleshooting/known-issues-patches-attached/hotfix-for-hipaa-package-1-2-0-compatibility-with-adobe-commerce-2-4-7-p4.md)
      * [Atualização de segurança disponível para Adobe Systems Comércio -[!DNL APSB25-08]](/help/troubleshooting/known-issues-patches-attached/security-update-available-for-adobe-commerce-apsb25-08.md)
      * [Alterações incompatíveis retroativas [!DNL GraphQL "placeOrder" API] do Adobe Systems Comércio 2.4.6-p8](/help/troubleshooting/known-issues-patches-attached/backwards-incompatible-changes-for-graphql-placeorder-api-in-adobe-commerce-2-4-6-p8.md)
      ...
      * [Solução de problemas de rotação de chave de criptografia: [!DNL CVE-2024-34102]](/help/troubleshooting/known-issues-patches-attached/troubleshooting-encryption-key-rotation-cve-2024-34102.md)
      * [Atualização de segurança disponível para Adobe Systems Comércio - [!DNL APSB24-40] Revisado para incluir correção isolados para [!DNL CVE-2024-34102]](/help/troubleshooting/known-issues-patches-attached/security-update-available-for-adobe-commerce-apsb24-40-revised-to-include-isolated-patch-for-cve-2024-34102.md)
      * [[!DNL UPS] migração da integração de método de envio de [!DNL SOAP] para [!DNL RESTful API]](/help/troubleshooting/known-issues-patches-attached/ups-shipping-method-integration-migration-from-soap-to-restful-api.md)
      ...
      * [Adobe Systems Comércio erro 2.4.6 que colocava solicitar do painel De administração](/help/troubleshooting/known-issues-patches-attached/adobe-commerce-2-4-6-error-placing-order-from-admin-panel.md)
      * [[!UICONTROL salesRule] problemas de rótulo ao atualizar a partir de versões &lt; 2.4.5](/help/troubleshooting/known-issues-patches-attached/salesrule-label-issues-when-upgrade-from-versions-under-2-4-5.md)
      * [[!DNL JQuery UI] correção de vulnerabilidade de [!DNL CVE-2022-31160] segurança para versões 2.4.4, 2.4.5 e 2.4.6](/help/troubleshooting/known-issues-patches-attached/jquery-cve-2022-31160-fix-2-4-4-2-4-5-2-4-6.md)
      * [[!DNL FedEx] Migração da integração de métodos de envio de SOAP para API RESTful](/help/troubleshooting/known-issues-patches-attached/fedex-shipping-method-integration-migration-soap-restful-api.md)
   * Elasticsearch {#elasticsearch}
      ...
      * [Índices rastreamento elasticos causam problemas com Elasticsearch](/help/troubleshooting/elasticsearch/elasticsuite-tracking-indices-causes-problems-with-elasticsearch.md)
      * [Verifique se Elasticsearch estão instaladas corretamente](/help/troubleshooting/elasticsearch/ensure-elasticsearch-is-installed-properly.md)
      * [Elasticsearch 5 está configurado, mas pesquisa página não carrega com &quot;Fielddata está desativado...&quot; erro](/help/troubleshooting/elasticsearch/elasticsearch-5-is-configured-but-search-page-does-not-load-with-fielddata-is-disabled-error.md)
      * [Elasticsearch Index Status é &#39;amarela&#39; ou &#39;vermelha&#39;](/help/troubleshooting/elasticsearch/elasticsearch-index-status-is-yellow-or-red.md)
      * [Elasticsearch serviço não está em execução](/help/troubleshooting/elasticsearch/elasticsearch-service-not-running.md)
      ...
      * [Elasticsearch é mostrado como o mecanismo de pesquisa apesar da instalação do OpenSearch](/help/troubleshooting/elasticsearch/search-engine-shown-elasticsearch-despite-open-search.md)
...
* Perguntas frequentes {#faq}
   ...
   * [Posso programar atualizações de Armazenamento de conteúdo para preços em um catálogo compartilhado?](/help/faq/general/can-i-schedule-content-staging-updates-for-prices-in-a-shared-catalog.md)
   * [Perguntas frequentes da ferramenta Adobe Systems Comércio de verificação de segurança](/help/faq/general/magento-security-scan-tool-faq.md)
   * [Perguntas frequentes sobre o fim do suporte ao software Adobe Systems Comércio](/help/faq/general/adobe-commerce-eos-policy-faq.md)
   * [Preciso do Fastly para um site de Adobe Systems sem cabeça Comércio?](/help/faq/general/do-i-need-fastly-for-a-headless-magento-site.md)
